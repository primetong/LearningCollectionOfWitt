...
import com.evguard.customview.DelSlideAdapter;
...
public class Fragment_Alam extends Fragment_Base {

	private static Fragment_Alam mInstance;
	...
	private CallBack_FragmentAlam mCallBack_FragmentAlam;
	
	
	public static Fragment_Alam getInstance() {
		if (mInstance == null)
			synchronized (lockobj) {
				mInstance = new Fragment_Alam();
			}
		return mInstance;
	}
	...
	public void initData() {
							...
							public void onClick(View v) {
								...
								mDg_Alert.setPositiveButton("确认", new OnClickListener() {
									...
									public void onClick(View v) {
										...
										mCallBack_FragmentAlam.deleteMessage(item.getID());
		...
		lvMessage.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				mCallBack_FragmentAlam.changeMessageStatus(messageInfo
						.getID());
				mAdapter.notifyDataSetChanged();
	...
	public void setCallBack_FragmentAlam(
			CallBack_FragmentAlam aOnMessageActionClickListener) {
		mCallBack_FragmentAlam = aOnMessageActionClickListener;
	}

	public interface CallBack_FragmentAlam {
